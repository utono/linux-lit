pub mod vocab_popup;
pub mod font;
use self::font::{reapply_font, rebuild_line_number_gutter};
pub mod text_prep;
...
use self::scene_synopsis::{is_first_line_of_scene, scene_heading_start, current_scene_divs, synopsis_label};
