...
fn handle_key_inner(
    ...
    // A bare Shift press is a plain modifier in EVERY mode — it is never
    // consumed here and carries no standalone action. (A lone-Shift-tap
    // timestamp delete/undo lived here until 2026-08-03; the timestamp binds
    // are now BackSpace double-tap to delete and Ctrl+b to undo.)
