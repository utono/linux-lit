...
const BOTTOM_ROW: &[KeyDef] = &[
    ...
    bare("x", "X", "pg fwd"),
    key("b", "B", "", "B: undo ts", &[("M-b", "set end time")]),
...
search, then the -/_ word underline.",
        ...
        "cycle font" => "Action::CycleFontForward — src/app/font.rs",
        "cycle font back" => "Action::CycleFontBackward — src/app/font.rs",
...
fn expand_action(label: &str) -> String {
    ...
    let full = match base {
        ...
        "cycle font" => "next font family",
        "cycle font back" => "previous font family",
